...
struct CollisionEvaluator
{
  ...
  const trajopt_common::SafetyMarginData::ConstPtr getSafetyMarginData() const
  {
...
public:
  SingleTimestepCollisionEvaluator(planning_scene::PlanningSceneConstPtr& planning_scene, std::string planning_group,
                                   trajopt_common::SafetyMarginData::ConstPtr safety_margin_data, const sco::VarVector& vars);
  /**
...
public:
  CastCollisionEvaluator(planning_scene::PlanningSceneConstPtr planning_scene, std::string planning_group,
                         trajopt_common::SafetyMarginData::ConstPtr safety_margin_data, const sco::VarVector& vars0,
  ...
  sco::VarVector GetVars() override
  {
    return trajopt_common::concat(m_vars0, m_vars1);
  }
